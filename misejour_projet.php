...
{
    $_SESSION['id_projet']=$_GET['codemodi'];
    $codemodi=$_GET['codemodi'];
    $req1 = $pdo->prepare('select * from projet where id_projet=:codemodification');
...
logout</span>Deconnexion</a>
    ...
    <div class="table-title">
      <div class="row">
        <div class="col-sm-6 p-0 d-flex justify-content-lg-start justify-content-center">
          <h2 class="ml-lg-2"> Ajouter un projet</h2>
        </div>  <br><br>
        </div>
        </div>
		<div class="conteneur">	
	<body>
		...
		<form name="form1" method="post" action="executermisejour_projet.php" >
			<div class="label">Id</div>
			<input type="text" name="t1" value="<?php echo $resultat['id_projet'];?>"required/>
			<div class="label">Nom du projet</div>
			<input type="text" name="t2"  value="<?php echo $resultat['nom_projet'];?>"required />
			<div class="label">Description</div>
			<input type="text" name="t3" value="<?php echo $resultat['description'];?>"required/>
			<div class="label">Date debut projet</div>
			<input type="text" name="t4" value="<?php echo $resultat['date_debut'];?>"required/>
            <div class="label">Date fin projet</div>
			<input type="text" name="t5" value="<?php echo $resultat['date_fin'];?>"required/>
