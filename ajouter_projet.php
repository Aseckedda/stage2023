...
logout</span>Deconnexion</a>
    ...
    <div class="table-title">
	  ...
	  Ajouter un projet
			...
			<form name="form1" method="post" action="create_projet.php" >
				<div class="label">Nom du projet</div>
				<input type="text" name="nom_projet" required/>
				<div class="label">Description</div>
				<input type="text" name="description" required/>
				<div class="label">Date du début projet</div>
				<input type="date" name="date_debut" required/>
				<div class="label">Date du fin projet</div>
				<input type="date" name="date_fin" required/>
				<input type="submit" name="valider" value="Enregister" /><br>
			</form>	
	
	<input type="button" name="button" id="button" value="Liste des projets" OnClick="window.location.href='liste.php' "><br>		
	<input type="button" name="button1" id="button" value="Retour" OnClick="window.location.href='tableau_bord_admin.php' ">	
