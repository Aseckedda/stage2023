        ...
        <div class="col-sm-6 p-0 d-flex justify-content-lg-start justify-content-center">
          <h2 class="ml-lg-2"> Affecter un agent</h2>
            ...
            <div class="container">
                ...
                <form method="post" action="affecter_agent.php">
                    <label for="id_agent">Numéro ID de l'Agent:</label>
                    <input type="text" name="id_agent" id="id_agent" required><br><br>
                    
                    <label for="id_projet">Numéro ID du Projet:</label>
                    <input type="text" name="id_projet" id="id_projet" required><br><br>
